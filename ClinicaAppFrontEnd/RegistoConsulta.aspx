...
<body>
    <form id="form1" runat="server">
        ...
        <div align="center" class="auto-style13">
            ...
            <br />
            <asp:Button ID="Button1" runat="server" CausesValidation="False" CssClass="auto-style14" Height="34px" Text="Voltar para Menu Principal" Width="168px" OnClick="Button1_Click" />
